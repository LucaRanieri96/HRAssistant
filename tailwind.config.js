...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-0': ['64px', { lineHeight: '1.15', letterSpacing: '-0.01em', fontWeight: '700' }],
        ...
        'display-3': ['52px', { lineHeight: '1.2', letterSpacing: '-0.01em', fontWeight: '700' }],
        ...
        'icon-xxl': ['96px', { lineHeight: '1' }],
        'icon-xl': ['64px', { lineHeight: '1' }],
        'icon-l': ['48px', { lineHeight: '1' }],
        'icon-m': ['40px', { lineHeight: '1' }],
        'icon-s': ['24px', { lineHeight: '1' }],
        'icon-xs': ['20px', { lineHeight: '1' }],
      },
      spacing: {
        2: '8px',
        3: '12px',
